...
namespace UriShop.Controllers
{
    public class DireccionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DireccionID,Address,Ciudad,Provincia,Estado,CodigoPostal,UsuarioID")] Direccion direccion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DireccionID,Address,Ciudad,Provincia,Estado,CodigoPostal,UsuarioID")] Direccion direccion)
        {
