...
namespace UriShop.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UsuarioId,Nombre,Telefono,NombreUsuario,Contrasenia,Correo,Direccion,Ciudad,Provincia,CodigoPostal,RolId")] Usuario usuario)
        {
